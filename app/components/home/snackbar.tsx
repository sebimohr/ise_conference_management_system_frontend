...
export default function Snackbar(props: { message: string, severity: SeverityEnum, isVisible: boolean }) {
  ...
  return (
    props.isVisible ? alert : <></>
  )
}

function successAlert(alertIcon: React.JSX.Element, message: string) {
  return (
    <div className={"bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md p-4"}
         role="alert">
      <div className="flex">
...
function warningAlert(alertIcon: React.JSX.Element, message: string) {
  return (
    <div className={"bg-amber-100 border-t-4 border-amber-500 rounded-b text-amber-900 px-4 py-3 shadow-md p-4"}
         role="alert">
      <div className="flex">
        <div className="py-1">{alertIcon}</div>
        <p className="font-bold">{message}</p>
...
function errorAlert(alertIcon: React.JSX.Element, message: string) {
  return (
    <div className={"bg-rose-100 border-t-4 border-rose-500 rounded-b text-rose-900 px-4 py-3 shadow-md p-4"}
         role="alert">
      <div className="flex">
        <div className="py-1">{alertIcon}</div>
        <p className="font-bold">{message}</p>
