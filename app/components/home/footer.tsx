...
export default function Footer() {
  ...
  const [snackBarSeverity, setSnackBarSeverity] = useState(SeverityEnum.success);
  ...
  return (
    <div>
      <Snackbar message={snackBarMessage} severity={snackBarSeverity} isVisible={snackBarVisibility}/>
